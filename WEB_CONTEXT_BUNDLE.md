...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-791-erd-s-problem-791-576c2c63-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-791"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-791-erd-s-problem-791-576c2c63-v1",
      "problem_contract_sha256": "89fa14ba56e1fc597ca0b2255f0ec1817b3ce9a10024545e54da9ce12140e18d",
      "problem_id": "problem:um-ep-791-erd-s-problem-791-576c2c63",
      "route_id": "route:um-ep-791-erd-s-problem-791-576c2c63-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-791-erd-s-problem-791-576c2c63-source-fidelity-01",
      "graph_id": "graph:um-ep-791-erd-s-problem-791-576c2c63-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-791-erd-s-problem-791-576c2c63-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-791-erd-s-problem-791-576c2c63-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $g(n)$ be minimal such that there exists $A\\subseteq \\{0,\\ldots,n\\}$ of size $g(n)$ with $\\{0,\\ldots,n\\}\\subseteq A+A$. Estimate $g(n)$. In particular is it true that $g(n)\\sim 2n^{1/2}$?"
          },
          "statement_sha256": "af96d383b613325851607007b58d185812d05d3db4f34e65fe2d47a56ee9f9ea"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-791-erd-s-problem-791-576c2c63-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-791-erd-s-problem-791-576c2c63-root",
      "route_id": "route:um-ep-791-erd-s-problem-791-576c2c63-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-791-9c5026bf2a34",
        "url": "https://www.unsolvedmath.com/problems/EP-791"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
